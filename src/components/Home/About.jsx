...
const About = () => {
    return (
        <section id="about" className="bg-transparent  text-gray-800 dark:text-gray-100 pt-8 pb-12 max-w-screen-2xl mx-auto">
            <div className="px-5 lg:px-0">

                {/* What I Do Section */}
                <div className="mt-5">
                    <h2 className="text-2xl font-bold text-center mb-8 uppercase">What I Do</h2>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div className="p-10 rounded-xl bg-gray-200 dark:bg-primary  shadow hover:shadow-lg overflow-hidden  border-2 border-transparent hover:border-blue-400 duration-300 hover:scale-[1.05] transition-all">
                ...
                {/* Education Section */}
                <div className="mt-16 ">
                    <h2 className="text-2xl font-bold text-center mb-8 uppercase">Education</h2>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center justify-between">
                        <div className="p-10 rounded-xl bg-gray-200 dark:bg-primary  shadow hover:shadow-lg overflow-hidden  border-2 border-transparent hover:border-blue-400 duration-300 hover:scale-[1.05] transition-all space-y-3">
                ...
                <div className="mt-16">
                    <h2 className="text-2xl font-bold text-center mb-8 uppercase">Why Choose Me</h2>
