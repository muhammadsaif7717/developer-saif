...
const Contact = () => {
    ...
    return (
        <div id='contact' className='flex flex-col bg-gray-200 my-5  items-center justify-center dark:bg-[#00283A] dark:text-white p-8 md:p-12 lg:p-16 rounded-xl'>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2  justify-between  gap-10">
                <div className="w-full grid grid-cols-1 items-center justify-center p-0 m-0">
                    ...
                    <div className="mt-6 space-y-8 md:mt-8 w-full  flex flex-col items-center lg:items-start">
                        ...
                        <Link href={`https://wa.me/+8801572900381"`} target='_blank' className="flex items-start -mx-2  hover:scale-105 duration-200">
                        ...
                        <Link href={`mailto:muhammadsaif7717@gmail.com`} className="flex items-start -mx-2   hover:scale-105 duration-200">
                        ...
                        <ul className="flex items-center justify-center space-x-4">
                            <li>
                                <Link href="https://drive.usercontent.google.com/download?id=1bI07nOE949lIj5kUNtlEAKhIqo_sMt5w&export=download&authuser=0&confirm=t&uuid=8558bd91-87cf-4b27-9a7f-97195f7ed006&at=APZUnTXVDpPcCqfjJpsBcaY4hQYy:1720077436011"
                                    ...
                                    <button className="flex justify-center gap-2  px-2 py-2 rounded-full text-white shadow-xl bg-[#0082C4] hover:bg-[#3cbbfa] hover:scale-105 duration-500 w-[140px]">Resume<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="w-5 h-5 animate-bounce-slow"><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 13.5 12 21m0 0-7.5-7.5M12 21V3"></path></svg>
                                    </button>
                                </Link>
                            </li>
                            <li>
                ...
                <div className='w-full'>
                    <div className='bg-gray-200 dark:bg-[#00283A] dark:text-white rounded-xl flex flex-col items-center justify-center'>
                        <form onSubmit={handleSend} className='flex flex-col gap-5 max-w-screen-lg mx-auto'>
                            ...
                            <input type="text" name="name" placeholder='Name' className="input bg-base-100 dark:bg-[#02162B] rounded-xl w-full  outline-none
                            ...
                            " required />
                            <input type="email" name="email" placeholder='Email' className="input  bg-base-100 dark:bg-[#02162B]  rounded-xl w-full  outline-none
                            overflow-hidden  border-2 border-transparent hover:border-blue-400 hover:shadow-[0_0_30px_rgba(127,72,230,0.2)] duration-300 hover:scale-[1.02] transition-all
                            " required />
                            <input type="text" name="subject" placeholder='Subject' className="input  bg-base-100 dark:bg-[#02162B]  rounded-xl w-full  outline-none
                            overflow-hidden  border-2 border-transparent hover:border-blue-400 hover:shadow-[0_0_30px_rgba(127,72,230,0.2)] duration-300 hover:scale-[1.02] transition-all
                            " required />
                            <textarea name="message" placeholder='Message' className="input  bg-base-100 dark:bg-[#02162B]  rounded-xl w-full outline-none pt-3 h-24
                            overflow-hidden  border-2 border-transparent hover:border-blue-400 hover:shadow-[0_0_30px_rgba(127,72,230,0.2)] duration-300 hover:scale-[1.02] transition-all
                            " required></textarea>
