    ...
    <div className="mt-5">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <div className="overflow-hidden rounded-xl border-2 border-transparent bg-gray-200 p-10 shadow transition-all duration-300 hover:scale-[1.05] hover:border-blue-400 hover:shadow-lg dark:bg-primary">
          ...
          <p>
            I create dynamic, responsive web applications using the MERN stack,
        ...
        <div className="overflow-hidden rounded-xl border-2 border-transparent bg-gray-200 p-10 shadow transition-all duration-300 hover:scale-[1.05] hover:border-blue-400 hover:shadow-lg dark:bg-primary">
          ...
          <p>
            I design intuitive user interfaces with a focus on aesthetics and
            usability using tools like Tailwind CSS.
          </p>
        </div>
        <div className="overflow-hidden rounded-xl border-2 border-transparent bg-gray-200 p-10 shadow transition-all duration-300 hover:scale-[1.05] hover:border-blue-400 hover:shadow-lg dark:bg-primary">
          <Image
