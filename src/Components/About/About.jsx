        ...
        <div id='about' className='min-h-screen flex flex-col justify-center items-center'>
            ...
            <div className='w-full grid grid-cols-1 lg:grid-cols-2 items-center justify-center gap-5'>
                <div className='bg-[#00283A] rounded-xl p-10 card-body h-full'>
                    <h1 className='text-xl mb-5 text-center font-semibold  ml-2 text-blue-400'>About Me...</h1>
                ...
                <div className='bg-[#00283A] rounded-xl p-10 card-body h-full'>
                    <h1 className='text-xl mb-5 text-center font-semibold  ml-2 text-blue-400'>My Vision...</h1>
                ...
                <div className='bg-[#00283A] rounded-xl p-10 card-body h-full lg:col-span-2'>
                    <h1 className='text-xl mb-5 text-center font-semibold  ml-2 text-blue-400'>My Education...</h1>
                    <div className='grid grid-cols-1 md:grid-cols-2  gap-5 items-center justify-between'>
                        <div className=' h-full text-center'>
                            <h1 className=' font-semibold teo'>Diploma In Computer Science and Technology</h1>
                            <p className='text-sm'>Dhaka Polytechnic Institute</p>
                            <p className='text-sm'>Present</p>
                        </div>
                        <div className=' h-full text-center'>
                            <h1 className=' font-semibold '>Secondary School Certificate (SSC)</h1>
                            <p className='text-sm'>Setabgonj Ideal Academy</p>
                            <p className='text-sm'>2022</p>
                        </div>
                    </div>
                </div>
                <div className='bg-[#00283A] rounded-xl p-10 lg:col-span-2 card-body h-full'>
                    <h1 className='text-xl mb-5 text-center font-semibold  ml-2 text-blue-400'>My Skills...</h1>
