...
import { getBlogById } from '@/lib/getApi';
...
export default function EditBlogPage() {
  ...
  useEffect(() => {
    if (
      ...
      (!blogData || formData.title !== blogData.title)
    ) {
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex gap-4 pt-4">
            ...
            <button
              type="submit"
              disabled={updateBlogMutation.isPending || isUploading}
